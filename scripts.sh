...
#
## mutag dataset
#python3 pipeline.py --dataset mutag --min_samples 1000 --significance 0.05 --p_perturb 0.91 --sigma 0.09 --k 10
#
#python3 pipeline.py --dataset mutag --min_samples 1000 --significance 0.05 --p_perturb 0.91 --sigma 0.09 --k 15
#
#python3 pipeline.py --dataset mutag --min_samples 1000 --significance 0.05 --p_perturb 0.91 --sigma 0.09 --k 20
#
#python3 pipeline.py --dataset mutag --min_samples 1000 --significance 0.05 --p_perturb 0.91 --sigma 0.09 --k 25

python3 pipeline.py --dataset mutag --min_samples 1000 --significance 0.05 --p_perturb 0.91 --sigma 0.09 --k 30
